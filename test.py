...
# 동판 나오는 채널 제일정보 , KR1 , KR2 , KR3	
	if message.content == '!동판':
		if message.channel.id == (667243782604849155) or message.channel.id == (667247397075681299) or message.channel.id == (695294323272450048) or message.channel.id == (667245522549211138) or message.channel.id == (667246234851082240) or message.channel.id == (667245576014004256) or message.channel.id == (667241204739604490) or message.channel.id == (667245114619592765) or message.channel.id == (695294737191534643):
