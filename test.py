...
# 동판 나오는 채널 제일정보 , KR1 , KR2 , KR3	
	if message.content == '!동판':
		if message.channel.id == (667243782604849155) or message.channel.id == (667242915378102293) or message.channel.id == (695295847524728912) or message.channel.id == (695295351309074532) or message.channel.id == (667239441307533312) or message.channel.id == (688654225286234146) or message.channel.id == (667246600019771472) or message.channel.id == (667247545893781524) or message.channel.id == (695295447895506944) or message.channel.id == (667245023359664142) or message.channel.id == (667247261734141962) or message.channel.id == (695294841558532277) or message.channel.id == (695295376944791565) or message.channel.id == (695295397471453276) or message.channel.id == (667243696915218432) or message.channel.id == (667247397075681299) or message.channel.id == (695294323272450048) or message.channel.id == (667245522549211138) or message.channel.id == (667246234851082240) or message.channel.id == (667245576014004256) or message.channel.id == (667241204739604490) or message.channel.id == (667245114619592765) or message.channel.id == (695294737191534643):
