...
# 동판채증 문구 안나오는 채널 제일정보통신 / 홍남옥 영업1  /KR1 / KR2 / KR3   
	if message.content.startswith('!동판'):
		if message.channel.id != (667243782604849155) and message.channel.id != (677215049424699403) and message.channel.id != (667245522549211138) and message.channel.id != (667246234851082240) and message.channel.id != (667245576014004256) and message.channel.id != (667241204739604490):
			embed = discord.Embed(
			title='',
...
# 동판 나오는 채널 제일정보 , KR1 , KR2 , KR3	
	if message.content == '!동판':
		if message.channel.id == (667243782604849155) or message.channel.id == (667245522549211138) or message.channel.id == (667246234851082240) or message.channel.id == (667245576014004256) or message.channel.id == (667241204739604490):
